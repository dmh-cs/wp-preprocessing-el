...
def test__clean_sentence():
  ...
  clean_sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
                    "links": [{"page": "Kaapstad", "text": "Kaapstad"}]}
  assert result == clean_sentence

def test__clean_sentence_drop_link():
  sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in ( ; Kaapstad) word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
              "links": [{"page": "Kaapstad", "text": "Kaapstad"}]}
  result = dc._clean_sentence(sentence)
...
def test__clean_sentence_whitespace():
  sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
              "links": [{"page": " Kaapstad", "text": "Kaapstad"}]}
  result = dc._clean_sentence(sentence)
  clean_sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
...
def test__clean_sentence_mention_whitespace():
  sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
              "links": [{"page": " Kaapstad", "text": " Kaapstad"}]}
  result = dc._clean_sentence(sentence)
  clean_sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
...
def test__clean_sentence_mention_only_whitespace():
  sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
              "links": [{"page": " Kaapstad", "text": " "}]}
  result = dc._clean_sentence(sentence)
  clean_sentence = {"text": "Die Parade tussen Plein-, Buitenkant-, Darling- en Kasteelstraat in Kaapstad word as markplein, parkeerterrein en vir massabyeenkomste gebruik.",
                    "links": []}
  assert result == clean_sentence
